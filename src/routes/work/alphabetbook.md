...
order: 1100
description: Created as part of a series of books focused on typographic exploration. Each page progresses through the alphabet using strings to create the letterforms. For each letter one more string is added. Selected spreads.
---
